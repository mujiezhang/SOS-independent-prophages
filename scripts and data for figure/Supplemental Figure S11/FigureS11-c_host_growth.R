...
data_sets <- list(
  list(
    file = "7_Tome-predicted_ogt_all_host_category.txt", 
    title = "Tome_T",
    y_label = "Tome_T"
  ),
  list(
    file = "8_all_host_T_catagory.txt", 
    title = "SPOT_T",
    y_label = "SPOT_T"
  ),
  list(
    file = "9_all_host_ph_catagory.txt",
    title = "Dataset 3: pH",
    y_label = "pH"
  ),
  list(
    file = "10_all_host_salinity_catagory.txt",  
    title = "Dataset 4: salinity",
    y_label = "salinity"
  )
  # 可以根据需要添加更多数据集
)
...
grid.arrange(
  arrangeGrob(grobs = plot_list_no_legend, ncol = 6, nrows = 4), 
  legend, 
  #ncol = 5, 
  widths = c(20, 1) ,
  heights = c(1, 1.5) 
