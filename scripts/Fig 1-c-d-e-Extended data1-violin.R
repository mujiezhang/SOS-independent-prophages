library(ggplot2) 
# Fig 1 c-d-e and Extended data 1 use the same template for violin plot
wp3=read.table('Fig1-d-WP3_whole_genome_HI.txt',head=TRUE,sep='\t')
wp33=read.table('Fig1-d-WP3_point.txt',head=TRUE,sep='\t')
